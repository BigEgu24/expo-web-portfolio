...
export default function Contact() {
  ...
  const formSubmit = async (e) => {
    e.preventDefault();
    const id =
      "AKfycbyrGLJAMSNMDZFFVLcH5QOetvfS0MKHDp2veGW8IdW7GS1ACkVXKL-LTMBNlURmF4GCIQ";
    const URL = `https://script.google.com/macros/s/${id}/exec`;
    const message = `
            <h3>
                Message from ${capitalize(
                  input.name
                )} using the Portfolio Contact Form
            </h3>
            <p>
                ${input.message}
            </p>
  ...
  return (
    ...
    >
      <Wrapper>
        ...
        >
          <Link to={PUBLIC_URL} className="back-btn flex">
      ...
      <div className="contact-form absolute flex column">
        <form
          ...
          method="POST"
          style={responsiveStyles.formContainer}
        >
          ...
          <div
            className="flex"
            style={{ ...responsiveStyles.buttonContainer, float: "right" }}
          >
